        ...
        <div class="content mt-3">
            <div class="card bg-success bg-gradient">
                <div class="card-body">
                    ...
                    <a href="kategori/kategori.php" class="btn text-light">Kategori Buku</a>
                    <a href="buku/buku.php" class="btn text-light">Buku</a>
                    <a href="user/user.php" class="btn text-light">Users</a>
                    <a href="peminjaman/peminjaman.php" class="btn text-light">Peminjaman</a>
                ...
                <div class="col-sm-3">
                    <div class="card">
                        <div class="card-body bg-danger text-center">
                            <h3>Kategori Buku</h3>
                            <hr>
                            <a href="kategori/kategori.php" class="btn btn-dark btn-sm">Lihat Data</a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                ...
                <div class="col-sm-3">
                    <div class="card">
                        <div class="card-body bg-primary text-center">
                            <h3>Peminjaman</h3>
                            <hr>
                            <a href="peminjaman/peminjaman.php" class="btn btn-dark btn-sm">Lihat Data</a>
                        </div>
                    </div>
                </div>
            </div>
